...
public class NewElementTypeCompositeCommand extends AbstractNewTypeCompositeCommand {
    ...
    public NewElementTypeCompositeCommand(final IModelRoot modelRoot, final IModelObject modelObject,
    ...
    protected AbstractNotificationOperation createCreateTypeCommand() {
        return new AddStructureTypeCommand((IXSDModelRoot) schema.getModelRoot(), schema,
                Messages.AddStructureTypeCommand_create_new_global_element_command_label, typeName, true, (AbstractType) Schema
