...
public class NewStructureTypeWithAddSchemaCompositeCommand extends AbstractNewTypeWithAddSchemaCompositeCommand {

    public NewStructureTypeWithAddSchemaCompositeCommand(IModelRoot root, IModelObject modelObjToRefresh, String operationLabel,
    ...
    protected AbstractNewTypeCompositeCommand createAddNewTypeCommand(ISchema schema) {
        return new NewStructureTypeCompositeCommand(schema.getModelRoot(), modelObject, operationLabel, schema, typeName,
