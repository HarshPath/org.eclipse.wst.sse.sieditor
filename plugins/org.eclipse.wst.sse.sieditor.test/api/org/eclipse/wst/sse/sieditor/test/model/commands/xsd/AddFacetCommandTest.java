...
public class AddFacetCommandTest extends AbstractCommandTest {
    ...
    protected void assertPostRedoState(final IStatus redoStatus, final IWsdlModelRoot modelRoot) {
        assertEquals(MIN_LENGTH_FACET_VALUE, type.getMinLength());
    }
    ...
    protected AbstractNotificationOperation getOperation(final IWsdlModelRoot modelRoot) throws Exception {
        ...
        return new AddFacetCommand(modelRoot, type, getXSDPackage().getXSDMinLengthFacet(), null, MIN_LENGTH_FACET_VALUE);
    }
}
