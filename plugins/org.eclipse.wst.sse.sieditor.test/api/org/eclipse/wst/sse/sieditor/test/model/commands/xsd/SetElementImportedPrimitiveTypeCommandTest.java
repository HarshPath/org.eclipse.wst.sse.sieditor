...
public class SetElementImportedPrimitiveTypeCommandTest extends SetElementTypeAbstractCommandTest {
    private static final String IMPORTED_TYPE_NAME = "SKU";
    private static final String IMPORTED_SCHEMA_NAMESPACE = "http://www.example.com/";
    private static final String NEW_ELEMENT_NAME = "importedPrimitiveTypeElement";
