...
public class AttributeStrategyTest extends ElementOfGlobalTypeStrategyTest {
    
    @Override
    protected ElementOfGlobalTypeStrategy createStrategy() {
        return new AttributeStrategy(controllerMock);
    }
    ...
    public void testIsNillableApplicable() {
        Assert.assertEquals(false, strategy.isNillableApplicable());    }

    @Test
    public void testIsNillableEditable() {
        Assert.assertEquals(false, strategy.isNillableEditable());
    }
