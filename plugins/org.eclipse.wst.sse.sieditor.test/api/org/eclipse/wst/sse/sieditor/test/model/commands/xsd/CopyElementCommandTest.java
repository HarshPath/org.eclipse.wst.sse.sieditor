...
public class CopyElementCommandTest extends AbstractCommandTest {
    ...
    protected void assertPostRedoState(final IStatus redoStatus, final IWsdlModelRoot modelRoot) {
        ...
        assertEquals(2, address.getElements("FunctionalTitleName").size());
    }

    @Override
    protected void assertPostUndoState(final IStatus undoStatus, final IWsdlModelRoot modelRoot) {
        final IStructureType address = (IStructureType) schema.getType(false, "Address");
        assertEquals(1, address.getElements("FunctionalTitleName").size());
    }
    ...
    protected AbstractNotificationOperation getOperation(final IWsdlModelRoot modelRoot) throws Exception {
        ...
        type = (IStructureType) schema.getType(false, "Address");
        final Collection<IElement> elements = type.getElements("FunctionalTitleName");
