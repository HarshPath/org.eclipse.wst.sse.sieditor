...
public class RenameComplexTypeCommandTest extends RenameNamedComponentAbstractTest {
    private static final String INITIAL_TYPE_NAME = "myComplexTypeToBeRenamed";
    private static final String NEW_TYPE_NAME = "myComplexTypeAlreadyRenamed";
    ...
    protected IType addNewType(final IWsdlModelRoot modelRoot, final Schema schema) throws ExecutionException {
        ...
        final AddStructureTypeCommand addTypecmd = new AddStructureTypeCommand(xsdModelRoot, schema, INITIAL_TYPE_NAME, false, null) {
            @Override
