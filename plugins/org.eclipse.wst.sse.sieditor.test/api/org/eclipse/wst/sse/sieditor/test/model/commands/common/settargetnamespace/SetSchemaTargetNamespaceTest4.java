...
public class SetSchemaTargetNamespaceTest4 extends AbstractXSDCommandTest {
    ...
    protected AbstractNotificationOperation getOperation(final IXSDModelRoot modelRoot) throws Exception {
        ResourceUtils.copyFileIntoTestProject("pub/extract/DependentSchema1.xsd", Document_FOLDER_NAME, this.getProject(),
                "DependentSchema1.xsd");
