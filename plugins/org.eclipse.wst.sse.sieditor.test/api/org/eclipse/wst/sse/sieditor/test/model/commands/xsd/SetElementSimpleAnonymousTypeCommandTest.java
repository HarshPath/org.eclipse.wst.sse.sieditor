...
public class SetElementSimpleAnonymousTypeCommandTest extends SetElementAnonymousCommandAbstractTest {
    private static final String NEW_ELEMENT_NAME = "customAnonymousSimpleTypeElement";
    private static final String SIMPLE_TYPE_NAME = "string";

    @Override
    protected AbstractType getInitialType() throws ExecutionException {
        return (AbstractType) Schema.getDefaultSimpleType();
    }
