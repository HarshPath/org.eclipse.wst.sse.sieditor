...
public class AddFacetToElementTest extends AbstractCommandTest {

    private static final String LENGTH_FACET_VALUE = "3";
    ...
    protected void assertPostRedoState(final IStatus redoStatus, final IWsdlModelRoot modelRoot) {
        assertEquals(LENGTH_FACET_VALUE, ((ISimpleType) element.getType()).getLength());
    }
    ...
    protected AbstractNotificationOperation getOperation(final IWsdlModelRoot modelRoot) throws Exception {
        ...
        return new AddFacetToElementCommand(modelRoot, element, XSDPackage.XSD_LENGTH_FACET, LENGTH_FACET_VALUE);
    }
