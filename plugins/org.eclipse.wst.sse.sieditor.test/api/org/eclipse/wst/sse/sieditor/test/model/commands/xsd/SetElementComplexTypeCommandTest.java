...
public class SetElementComplexTypeCommandTest extends SetElementTypeAbstractCommandTest {
    private static final String NEW_ELEMENT_NAME = "customComplexTypeElement";
    ...
    protected AbstractType getNewType() throws ExecutionException {
        ...
        final AddStructureTypeCommand cmd = new AddStructureTypeCommand(xsdModelRoot, schema, COMPLEX_TYPE_NAME, false,
