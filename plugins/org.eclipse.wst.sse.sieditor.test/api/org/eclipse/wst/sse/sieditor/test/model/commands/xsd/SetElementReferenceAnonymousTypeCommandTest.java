...
public class SetElementReferenceAnonymousTypeCommandTest extends SetElementAnonymousCommandAbstractTest {
    private static final String NEW_ELEMENT_NAME = "customAnonymousRefElementToBeMadeAnonymous";
    private static final String GLOBAL_ELEMENT_NAME = "referredElement";
    ...
    protected AbstractType getInitialType() throws ExecutionException {
        ...
        final AddStructureTypeCommand addStructureCmd = new AddStructureTypeCommand(xsdModelRoot, schema, GLOBAL_ELEMENT_NAME,
                true, (AbstractType) Schema.getSchemaForSchema().getType(false, "int")) {
            @Override
