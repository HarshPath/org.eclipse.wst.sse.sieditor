...
public class RemoveXsdImportToImportedTypesCommandTest extends AbstractCommandTest {

    private static final String SCHEMA_TARGET_NAMESPACE = "http://namespace3";
    ...
    protected void assertPostExecuteState(final IStatus status, final IWsdlModelRoot modelRoot) {
        ...
        // there are four broken references, but there is duplication with the
        // original
        // validation
