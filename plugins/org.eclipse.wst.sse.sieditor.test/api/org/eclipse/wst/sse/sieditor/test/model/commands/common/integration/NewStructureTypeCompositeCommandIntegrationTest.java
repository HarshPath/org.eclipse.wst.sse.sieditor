...
public class NewStructureTypeCompositeCommandIntegrationTest extends AbstractCommandTest {

    private static final String ELEMENT_BASE_TYPE = "anyType";
    private Schema schema;
    private IStructureType structureType;
    private NewStructureTypeCompositeCommand command;
    ...
    protected AbstractNotificationOperation getOperation(final IWsdlModelRoot modelRoot) throws Exception {
        ...
        command = new NewStructureTypeCompositeCommand(modelRoot, structureType, "", schema, NEW_ELEMENT_NAME,
    ...
    protected void assertPostRedoState(final IStatus redoStatus, final IWsdlModelRoot modelRoot) {
        ...
        final IStructureType createdType = (IStructureType) modelRoot.getDescription().getSchema(TARGET_NAMESPACE)[0].getType(
                false, NEW_ELEMENT_NAME);
        assertNotNull(createdType);
        assertEquals(1, createdType.getAllElements().size());
