...
public class SetWrappedParameterTypeCommandTest extends AbstractCommandTest {
    ...
    protected void assertPostRedoState(final IStatus redoStatus, final IWsdlModelRoot modelRoot) {
        ...
        final OperationParameter parameter = (OperationParameter) operation.getAllInputParameters().iterator().next();
