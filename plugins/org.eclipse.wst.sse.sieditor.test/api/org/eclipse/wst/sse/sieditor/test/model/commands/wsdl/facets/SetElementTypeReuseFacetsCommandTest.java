 ...
 * base type</li>
 * <li>We are changing the type of ChildElement to float</li>
 * <li>ChildElement should still be of anonymous type, but should be of type
 * float</li>
 * </ol>
 * 
 *
 * 
 */
public class SetElementTypeReuseFacetsCommandTest extends AbstractCommandTest {
    ...
    protected void assertPostRedoState(IStatus redoStatus, IWsdlModelRoot modelRoot) {
        ...
        assertEquals("float", childElement.getType().getBaseType().getName());
    }
    ...
    protected AbstractNotificationOperation getOperation(IWsdlModelRoot modelRoot) throws Exception {
        ...
        return new SetElementTypeCommand(schema.getModelRoot(), childElement, Schema.getSchemaForSchema().getType(false, "float"));
    }
