...
import org.eclipse.wst.sse.sieditor.ui.v2.dt.extractwizard.table.SchemaFilesTableViewer;
...
public class SchemaDependenciesWizardPage extends WizardPage {
    ...
    public void createControl(final Composite parent) {
        ...
        setDescription(MessageFormat.format(Messages.SchemaDependenciesWizardPage_page_description, schemaNode.getNamespace()));
