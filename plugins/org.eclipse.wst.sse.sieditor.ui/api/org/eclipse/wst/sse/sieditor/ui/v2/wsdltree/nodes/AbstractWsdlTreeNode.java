...
public abstract class AbstractWsdlTreeNode extends AbstractTreeNode {

    public AbstractWsdlTreeNode(final IModelObject modelObject, final ITreeNode parent, final TreeNodeMapper nodeMapper,
            final int categories) {
        super(modelObject, parent, nodeMapper, categories);
    }

    public AbstractWsdlTreeNode(final IModelObject modelObject, final ITreeNode parent, final TreeNodeMapper treeNodeMapper) {
        super(modelObject, parent, treeNodeMapper);
    }

    @Override
    protected ITreeNodeLabelsProviderFactory getLabelsProviderFactory() {
        return SITreeNodeLabelsProviderFactory.instance();
    }
