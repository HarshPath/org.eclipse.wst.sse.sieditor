...
public class OperationBinding extends AbstractConstraint{
	...
	protected IStatus doValidate(IValidationContext ctx) {
		SOAPOperation operation = (SOAPOperation) ctx.getTarget();
		...
		if (binding != null) {
			...
			return ConstraintStatus.createStatus(ctx, operation, null, Messages.SOAPOperationBinding_0, binding.getQName().getLocalPart());
		}
		return ConstraintStatus.createSuccessStatus(ctx, operation, null);
	}
	...
	public Binding getBinding(SOAPOperation operation) {
