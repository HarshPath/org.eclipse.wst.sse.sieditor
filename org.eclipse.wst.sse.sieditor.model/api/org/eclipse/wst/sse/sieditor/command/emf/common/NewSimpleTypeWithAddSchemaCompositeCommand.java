...
public class NewSimpleTypeWithAddSchemaCompositeCommand extends AbstractNewTypeWithAddSchemaCompositeCommand {

    public NewSimpleTypeWithAddSchemaCompositeCommand(IModelRoot root, IModelObject modelObjToRefresh, String operationLabel,
    ...
    protected AbstractNewTypeCompositeCommand createAddNewTypeCommand(ISchema schema) {
        return new NewSimpleTypeCompositeCommand(schema.getModelRoot(), modelObject, operationLabel, schema, typeName,
